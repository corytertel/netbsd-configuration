...
bash_prompt() {
    ...
    #CUSTOM Yellow, Cyan, Magenta
	local FONT_COLOR_1=$CYAN
	local BACKGROUND_1=$DEFAULT
	local TEXTEFFECT_1=$BOLD

	local FONT_COLOR_2=$YELLOW
	local BACKGROUND_2=$DEFAULT
	local TEXTEFFECT_2=$BOLD

	local FONT_COLOR_3=$MAGENTA
    ...
    #CUSTOM Blue, Light Blue, Red
	#local FONT_COLOR_1=$DEFAULT
	#local BACKGROUND_1=$BLUE
	#local TEXTEFFECT_1=$BOLD

	#local FONT_COLOR_2=$DEFAULT
	#local BACKGROUND_2=$L_BLUE
	#local TEXTEFFECT_2=$BOLD

	#local FONT_COLOR_3=$DEFAULT
	...
	*)
	...
	############################################################################
	local NETBSD_LOGO=$"$TEXT_FORMAT_2  "
	#PS1="$TITLEBAR\n${PROMT_USER}${SEPARATOR_1}${PROMT_HOST}${SEPARATOR_2}${PROMT_PWD}${SEPARATOR_3}${PROMT_INPUT}"
	#PS1="$TITLEBAR\n${PROMT_USER}${PROMT_HOST}${PROMT_PWD}${PROMT_INPUT}"
	PS1="$TITLEBAR\n${NETBSD_LOGO}${PROMT_PWD}${PROMT_INPUT}"
